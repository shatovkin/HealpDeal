...
import com.example.dimitri.helpdeal.azureClasses.azureModels.ToDoItem;
...
import com.example.dimitri.helpdeal.azureClasses.azureAdapter.*;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            mClient = new MobileServiceClient(
                    "http://helpdeal.azurewebsites.net",
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            for (ToDoItem item : results) {
                                Log.d("TestTAG", item.getText().toString());
                                mAdapter.add(item);
                            }
                        }
                    });
 ...
 *//*   private List<ToDoItem> refreshItemsFromMobileServiceTableSyncTable() throws ExecutionException, InterruptedException {
   ...
   *//* private ArrayList<ToDoItem> getAllRows() throws MobileServiceLocalStoreException, ExecutionException, InterruptedException {
